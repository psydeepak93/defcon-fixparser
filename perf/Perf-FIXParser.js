...
const Table = require('cli-table'),
    ...
    messages = [
        ...
        },
        {
            ...
            detail: '',
            fix:
                '8=FIX.4.2\x019=76\x0135=A\x0134=702\x0149=ABC\x0152=20100130-10:52:40.663\x0156=XYZ\x0195=4\x0196=1234\x0198=0\x01108=60\x0110=134\x01',
        },
        {
            description: 'Test 2',
            detail: '',
            fix:
                '8=FIX.4.2\x019=59\x0135=A\x0149=XYZ\x0156=ABC\x0134=710\x0152=20100130-10:52:36\x0198=0\x01108=60\x0110=103\x01',
        },
        {
            description: 'Test 3',
            detail: '',
            fix:
                '8=FIX.4.2\x019=51\x0135=0\x0134=703\x0149=ABC\x0152=20100130-10:53:40.830\x0156=XYZ\x0110=249\x01',
        },
        {
            description: 'Test 4',
            detail: '',
            fix:
                '8=FIX.4.2\x019=47\x0135=0\x0149=XYZ\x0156=ABC\x0134=711\x0152=20100130-10:53:36\x0110=057\x01',
        },
        {
            description: 'Test 5',
            detail: '',
    ...
    runOnceRandom = () => {
        ...
        for (i; i < iterations; i++) {
            fixParser.parse(
                messages[Math.floor(Math.random() * messages.length)].fix,
            );
        }
        dateDiff = new Date() - startDate;
        rate = rateCalculation(iterations, dateDiff);
